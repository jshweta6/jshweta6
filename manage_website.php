                                    ...
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" placeholder="enter your name"  name="title" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <div class="row">
                                           <label class="col-sm-3 control-label">Description</label>
                                            <div class="col-sm-9">
                                        <textarea class="textarea_editor form-control" name="footer" rows="5" placeholder="Enter your description" style="height:300px;"></textarea>
                                      </div>
                                        </div>
                                    </div>
   <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  placeholder="enter your mobile number"  name="short_title" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <!-- <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" value="<?php echo "&#x20B9;"?>" name="currency_symbol" class="form-control">
                                                </div>
                                            </div>
                                        </div> -->
